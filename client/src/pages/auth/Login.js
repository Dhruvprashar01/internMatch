...
const Login = () => {
        ...
        return ( <
            ...
            onClick = {
                () => setToast({ show: false, msg: "" }) } > ✕ < /button> {
                toast.show && < div className = "lp-toast-bar"
                key = { toast.msg }
                />} <
                /div>
                ...
                div className = "auth-brand" >
                    ...
                    p className = "auth-brand-sub" > Intelligent internship matching powered by Gemini AI by Gaurav and Dhruv < /p> <
                    div className = "auth-brand-stats" >
                    <
                    div className = "auth-stat" > < span className = "auth-stat-num" > 10 K + < /span><span>Internships</span > < /div> <
                    div className = "auth-stat" > < span className = "auth-stat-num" > 50 K + < /span><span>Candidates</span > < /div> <
                ...
                div className = "auth-form-side" >
                    ...
                    p className = "auth-subtitle" > Sign in to your account to
                continue < /p>
                ...
                p className = "auth-footer-text" >
                    ...
                    Link to = "/register"
                className = "auth-link" > Create one free < /Link> <
                    /p>
                ...
                div className = "auth-demo-accounts" >
                    ...
                    <
                    button className = "auth-demo-chip"
                onClick = {
                        () => setForm({ email: "candidate@demo.com", password: "Demo1234" }) } > Candidate < /button> <
                    button className = "auth-demo-chip"
                onClick = {
                        () => setForm({ email: "company@demo.com", password: "Demo1234" }) } > Company < /button> <
                    button className = "auth-demo-chip"
                onClick = {
                        () => setForm({ email: "admin@internmatch.com", password: "Admin@1234" }) } > Admin < /button> <
                    /div> <
                    /div> <
                    /div> <
                    /div> <
